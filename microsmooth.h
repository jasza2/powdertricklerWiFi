...
int sga_filter(int current_value, long history_SGA[]); /*Needs to be tested*/
int kza_filter(int current_value, long history_KZA[]);
int rdp_filter(int current_value, long history_RDP[]);/*Iterative neeeds testing*/
int kfa_filter(int current_value, long history_KFA[]);/*Iterative neeeds testing*/
void deinit(long *);
